...
export const DemandaDetalleProv = () => {
  ...
  const getDemandaDetalle = async () => {
    try {
      ...
      const [respProducto, respComprador, respEstado] = await Promise.all([
        fetch(`${apiUrl}/productos?id=${demandaData.IdProducto}`),
        fetch(`${apiUrl}/usuarios?idUsuario=${demandaData.IdComprador}`),
      ...
      setComprador(dataComprador?.rows?.[0]);
  ...
  const crearPropuesta = () => {
    ...
    navigate("/crear_propuesta", {
      state: {
        ...
        Minimo: demanda.PrecioMinimo,
        Maximo: demanda.PrecioMaximo,
        urlImg: producto?.UrlImg || fallbackImg,
        cantMax: cantidadMaxima > 0 ? cantidadMaxima : demanda.Maximo,
      },
    });
  };
        ...
        <div className="comp-main-container__medCont__ofertas">
          <div className="explorarCat__title">
            ...
            <div style={{ marginLeft: "auto" }}>
              <EtiquetaDemanda estado={estadoDemanda?.Descripcion || "En curso"} />
            </div>
          </div>
          ...
          {loading && (
            <p className="paragraph">Cargando demanda...</p>
          )}
          ...
          {!loading && demanda && (
            <>
              ...
              <div className="oferta-detalle__descripcionBox">
                <p className="paragraph">
                  <b>Progreso de unidades solicitadas:</b>
                </p>
